<%-- 
    Document   : dasboard_home
    Created on : Jun 27, 2024, 2:36:18 AM
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">${TotalPerMonth.getFormattedPrice()} VND</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">${TotalPerYear.getFormattedPrice()} VND</div>
                                        </div>
                                        <div class="col-auto">
...
<!--                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-3">
                                            <i class="fas fa-circle text-primary"></i> BSN
                                        </span>
                                        <span class="mr-3">
                                            <i class="fas fa-circle text-success"></i> CS
                                        </span>
                                        <span class="mr-3">
                                            <i class="fas fa-circle text-info"></i> IT
                                        </span>
                                        <span class="mr-3">
                                            <i class="fas fa-circle text-info" style="color: #f6c23e"></i> MC
                                        </span>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Page level plugins -->
    <script src="${pageContext.request.contextPath}/static_dasboard/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="${pageContext.request.contextPath}/static_dasboard/js/demo/chart-area-demo.js"></script>
    <script src="${pageContext.request.contextPath}/static_dasboard/js/demo/chart-pie-demo.js"></script>
<script>
    var chartData = {
        labels: [],
        data: []
    ...
    console.log("Chart Data Values:", chartData.data);

    // Gọi hàm khởi tạo biểu đồ trong tệp JS
...
<script>
    ...
    <c:forEach var="o" items="${PercentCategory}">
        chartDataPie.name.push('${o.getCategory_name()}');
        chartDataPie.percent.push(${o.getPercentage()});
    </c:forEach>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        initializePieChart(chartDataPie);
    });
</script>
